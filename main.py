...
from logic import (
    ...
    test_detection,
    setup_folders,
    test_detection_with_landmark_drawn,
)

# streamlit basic setup with one sidebar and main area
st.sidebar.title("Action Recognition App")
st.sidebar.markdown(
    "App to recognize actions from webcam feed and train LSTM model using mediapipe and tensorflow"
)
...
# setup_the_dependencies(in_browser_feed)
# test_webcam(in_browser_feed)
# test_detection(in_browser_feed)
# test_detection_with_landmark_drawn(in_browser_feed)
# setup_folders(in_browser_feed)
# train_model(in_browser_feed)
